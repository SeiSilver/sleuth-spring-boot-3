...
public class LoggingAspect {
  ...
  public Object logMethodExecution(ProceedingJoinPoint pjp, LogMethod logMethod) throws Throwable {
    ...
    try {
      ...
      stopWatch.stop();
      log.info("End execution of {} (running {} ms)", shortMethod, stopWatch.getTotalTimeSeconds());
      return result;
    } catch (Exception ex) {
      stopWatch.stop();
      log.error("Fail execution of {} (running {} ms)", shortMethod, stopWatch.getTotalTimeSeconds(), ex);
      throw ex;
    }
  }
